...
TFile f ("testInterfCorrection.root") ;
f.cd () ;
TCanvas c1 ;
h_MWW->SetLineColor (kGray + 2) ;
h_MWW_corr->SetLineColor (kBlue) ;
h_MWW_corr->GetXaxis ()->SetTitle ("m_{H}") ;
h_MWW_corr->SetTitle ("") ;
h_MWW->GetXaxis ()->SetTitle ("m_{H}") ;
h_MWW_corr->SetStats (0) ;
h_MWW->SetStats (0) ;
h_MWW->SetTitle ("") ;
h_MWW->Draw ("Ehist") ;
h_MWW_corr->Draw ("EPsamehist") ;

TCanvas c2 ;
h_MWW_VBF->SetLineColor (kGray + 2) ;
h_MWW_corr_VBF->SetLineColor (kBlue) ;
h_MWW_corr_VBF->GetXaxis ()->SetTitle ("m_{H}") ;
h_MWW_corr_VBF->SetTitle ("") ;
h_MWW_VBF->GetXaxis ()->SetTitle ("m_{H}") ;
h_MWW_VBF->SetTitle ("") ;
h_MWW_corr_VBF->SetStats (0) ;
h_MWW_VBF->SetStats (0) ;
h_MWW_VBF->Draw ("Ehist") ;
h_MWW_corr_VBF->Draw ("EPsamehist") ;

  KEY: TH1F	h_MWW;1	h_MWW
  KEY: TH1F	h_MWW_corr;1	h_MWW
  KEY: TH1F	h_MWW_VBF;1	h_MWW_VBF
  KEY: TH1F	h_MWW_corr_VBF;1	h_MWW_VBF
